# Ejercicio: Explicación de un comando de terminal desde GitHub Copilot CLI en modo programático

## Objetivo

Aprender a utilizar la explicación de comandos desde la línea de comandos (CLI) utilizando GitHub Copilot CLI en modo programático
...
Explicar un comando típico a nivel de explicación de funcionalidad y de los parámetros que utiliza
...
```bash
# Ejemplo 1
copilot -p "explain 'ls -la'"

# Ejemplo 2
copilot -p "Explain 'git commit -m \"Initial commit\"'"
```
