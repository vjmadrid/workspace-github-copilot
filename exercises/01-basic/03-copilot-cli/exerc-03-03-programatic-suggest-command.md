# Ejercicio: Sugerencia de un comando de terminal desde GitHub Copilot CLI en modo programático

## Objetivo

Aprender a utilizar GitHub Copilot CLI en modo programático para sugerir comandos de terminal basados en descripciones en lenguaje natural
...
Sugerir un comando de terminal desde la línea de comandos (CLI) utilizando GitHub Copilot CLI en modo programático
...
```bash
# Ejemplo 1
copilot -p "Crear un comando para encontrar todos los archivos modificados en los últimos 7 días"
```
